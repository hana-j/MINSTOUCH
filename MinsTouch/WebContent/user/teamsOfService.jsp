...
<!-- 섹션부분 -->	
	...
	<main id ="teamsOfService">
		<span class="font">이용약관</span>
		<br><br><br>
		<div class="box1">
			
이 약관은 (주)민스터치(전자거래 사업자)이 운영하는 홈페이지(이하 "쇼핑몰"이라 한다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 한다)를 이용함에 있어 (유)내고향시푸드와 이용자의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
<br>
