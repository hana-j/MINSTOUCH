...
width:20px;height:6px;background:#f9f8f6;} 
	...
	<main class="a">
		<!--가맹안내 메인이미지-->
			<img src="${pageContext.request.contextPath}/img/user_img/customer.png" width="70%" height="16%">
			<div class="succ1">
		...
		<!--상담문의 헤드-->		
				<div class="succ2">
					<br>
					<span class="h2color">고객문의</span>
					<br><br>
					저희 브랜드를 이용하시며 아쉬웠던 점, 만족스러웠던 점 등.<br>고객님의 귀한 의견 들려 주세요.
		...
		<!--민스터치 온라인상담 폼-->
			...
			*는 필수 입력 항목입니다.
			...
			<br><br><br><br><br>
				...
				<tr>
					<td class="sangdamf"><b>이용 한 매장</b>*</td>
					<td>
						<select name="city">
				...
				<tr>
					<td class="sangdamf"><b>구분</b>*</td>
					<td>
					<input type="radio" name="chk_jumpo" value="thku">칭찬접수&nbsp;
					<input type="radio" name="chk_jumpo" value="nothku">불만접수&nbsp;
					<input type="radio" name="chk_jumpo" value="etc">기타
					</td>
					<br>
				</tr>
				<tr>
					<td class="sangdamf"><b>이용 서비스</b>*</td>
					<td>
					<input type="radio" name="jumpo" value="nogo">매장 방문 배달 그 외
					&nbsp;
					<input type="radio" name="jumpo" value="go">매장방문
					</td>
					<br>
				</tr>
					<tr>
				...
				<tr>
					...
					<td><input type="text" placeholder="이용 날짜 및 방문시간 등 자세히 기입해주시면 상담하는데 많은 도움이 됩니다!" style="width:90%;height:150%;font-size:5px;"></td>
				</tr>
				</table>
				<br><br><br><br>
				<div class="box1">
  				...
  				<div>
  				<br><br>
  				<a href="${pageContext.request.contextPath}/successperson.usr" ><img src="${pageContext.request.contextPath}/img/user_img/ok.png" width="10%" height="15%"></a>
  				</div>
  				</div>
