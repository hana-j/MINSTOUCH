...
<body>
	...
	<div class="main_image">
		<img src="${pageContext.request.contextPath}/img/user_img/mainImg.png" width="100%">
	</div>
	<section>
		<!--햄버거메뉴 이미지컷-->
		<div class="sec6">
			<br>
			<a href="${pageContext.request.contextPath}/burgerView.kiosk?id=burger5"><img src="${pageContext.request.contextPath}/img/sec_img/sec6-1.png"></a>
			<a href="${pageContext.request.contextPath}/burgerView.kiosk?id=burger9"><img src="${pageContext.request.contextPath}/img/sec_img/sec6-2.png"></a>
			<a href="${pageContext.request.contextPath}/burgerView.kiosk?id=burger10"><img src="${pageContext.request.contextPath}/img/sec_img/sec6-3.png"></a>
			<a href="${pageContext.request.contextPath}/burgerView.kiosk?id=burger8"><img src="${pageContext.request.contextPath}/img/sec_img/sec6-4.png"></a>
			<a href="${pageContext.request.contextPath}/burgerView.kiosk?id=buger6"><img src="${pageContext.request.contextPath}/img/sec_img/sec6-5.png"></a>
			<a href="${pageContext.request.contextPath}/burgerView.kiosk?id=burger11"><img src="${pageContext.request.contextPath}/img/sec_img/sec6-6.png"></a>
			<a href="${pageContext.request.contextPath}/burgerView.kiosk?id=burger12"><img src="${pageContext.request.contextPath}/img/sec_img/sec6-7.png"></a>
		</div>
		...
		<!--가맹점 점주모집-->
		<a href="${pageContext.request.contextPath}/chain.usr"><img src="${pageContext.request.contextPath}/img/sec_img/sec4.png" width="100%"></a>
		<!--민스버거 홍보이미지-->
